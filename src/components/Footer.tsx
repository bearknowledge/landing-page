			...
			<GridItem colSpan={{ xs: 5, md: 2 }}>
				<ScrollAnimation animation="fade-up">
					<Text fontSize={'12px'} fontWeight={400}>
						...
						for informational and educational purposes only. "The Xchange" is a
						decentralized protocol operated by autonomous smart contracts and
						does not have a vested interest in the outcomes of any market.
					</Text>
				</ScrollAnimation>
			</GridItem>
		</Grid>
